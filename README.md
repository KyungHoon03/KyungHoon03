...
- **2025년 ByteCookie** 🍪: "Re-Fly" 시니어 맞춤 채용 플랫폼
  `Spring Boot · AWS RDS · Oracle VM · Docker · GPT API · Docker`  [Re-Fly 작업 페이지]([https://github.com/CUKLLteam3/Backend](https://github.com/CUKLLteam3/ByteCookieServer))
...
- **2025년 알죠** ⏰: 여러 사용자가 동시에 참여할 수 있는 공유 알람을 핵심으로 하는 소셜 알람 애플리케이션
